...
const GetProductbyName = () => {
    ...
    if (!id) {
        return <div>Không tìm thấy sản phẩm. Vui lòng nhập id sản phẩm để tìm kiếm.</div>;
    }
                    ...
                    <div className="col c-12 m-12 l-10">
                        ...
                        <div className="home-product">
                            <div className="row">
                                ...
                                {products ? (
                                    <div className="col course-item c-6 m-3 l-2-4">
                                        <Link to={`/products/${products.id}`} className="home-product-item">
                                            <div className="home-product-item__img" style={{ backgroundImage: `url(${products.image})` }}>
                                            </div>
                                            <h4 className="home-product-item__name">{products.name}</h4>
                                            <div className="home-product-item__price">
                                                <span className="home-product-item__price-old">{products.old_price}</span>
                                                <span className="home-product-item__price-current">{products.price}</span>
                                            </div>
                                            ...
                                            <div className="home-product-item__origin">
                                                <span className="home-product-item__brand">{products.brand}</span>
                                                <spna className="home-product-item_origin-name">{products.made_in}</spna>
                                            </div>
                                ...
                                <div className="product__null">
                                    <i className="fa-solid fa-magnifying-glass product__null--icon" />
                                    <span className="product__null--text">Không tìm thấy kết quả nào!</span>
                                </div>
                                }

                            </div>
                        </div>
                        <ul className={ !products ? "c-0"  : "pagination home-product__pagination"}>
